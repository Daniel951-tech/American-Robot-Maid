...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            ...
            #textbutton _("Conquistas") action ShowMenu("achievements_screen")
...
screen main_menu():
    ...
    imagebutton idle im.Scale("gui/button/twitter icon.png", 55, 55) xpos 1490 ypos 1000 hover im.Scale("gui/button/twitter icon.png", 60, 60) action OpenURL("https://x.com/BoyGames95")
