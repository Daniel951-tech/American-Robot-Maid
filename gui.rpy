...
define gui.main_menu_background = Transform("gui/bandeira_americana.jpg", size=(1920,1080) )
define gui.game_menu_background = Transform("gui/baltana_fundo.png", size=(1920,1080))
